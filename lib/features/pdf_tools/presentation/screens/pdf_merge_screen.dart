    ...
    if (result != null) {
      setState(() {
        for (var path in result.paths) {
          if (path != null && !_pdfList.any((f) => f.path == path)) {
            _pdfList.add(File(path));
          }
        }
      });
    }
        ...
        body: _isProcessing
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 16),
              Text('PDF belgeleri birleştiriliyor...'),
            ],
          ),
        )
            : _pdfList.isEmpty
          ...
          itemBuilder: (context, index) {
            ...
            return Card(
              key: ValueKey(file.path), // Index kaldırıldı, stabil hale geldi
