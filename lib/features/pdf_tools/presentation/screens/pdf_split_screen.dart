...
class _PdfSplitScreenState extends State<PdfSplitScreen> {
  ...
  int _totalPages = 0;
  final Set<int> _selectedIndices = {}; // 0-tabanlı
  ...
  void _showPagePreviewDialog(int pageIndex) {
    // Gelecek nesnesi diyalog açılmadan önce tek seferlik başlatılır:
    final renderFuture = _renderPageToPng(pageIndex, 120);
                        ...
                        children: [
                          ClipRRect(
                            ...
                            child: _thumbnailBytesCache.containsKey(index)
                              ...
                              // Thumbnail için 50 DPI hem kristal netlik hem sıfır RAM yükü sağlar:
                              future: _renderPageToPng(index, 50),
                              builder: (context, snapshot) {
